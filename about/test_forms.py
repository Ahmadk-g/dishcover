...
class TestCollaborateForm(TestCase):
    ...
    def test_name_is_required(self):
        ...
        self.assertFalse(form.is_valid(), msg="Missing name, but valid form")
    ...
    def test_email_is_required(self):
        ...
        self.assertFalse(form.is_valid(), msg="Missing Email, but valid form")
    ...
    def test_message_is_required(self):
        ...
        self.assertFalse(form.is_valid(), msg="Missing message,but valid form")
    ...
    def test_form_is_empty(self):
        ...
        self.assertEqual(len(form.errors), 3)  # Expecting 3 missing fields
