...
class Category(models.Model):
    ...
    def clean(self):
        ...
        if Category.objects.filter(name__iexact=formatted_name).exists():
            raise ValidationError(f"The recipe category '{formatted_name}' already exists.")
...
class Recipe(models.Model):
    ...
    categories = models.ManyToManyField(Category, related_name='recipe_type')
