...
from io import BytesIO  # To simulate a file-like object with byte data
import os
...
class RecipeTests(TestCase):
    ...
    def setUp(self):
        ...
        # Load a static image file for testing from root directory for testing
        ...
        # Allows us to create a mock image file that can be used for testing
    ...
    def test_recipe_list_view(self):
        ...
        - Ensures the correct template is used and
        the recipe title is present in the response.
        """
    ...
    def test_recipe_details_view(self):
        ...
        - Sends a GET request to the recipe details view using slug
        - Checks that the response status is 200 OK.
        - Ensures the correct template is used and
          the recipe details are present in the response.
        """

        response = self.client.get(reverse('recipe_details',
    ...
    def test_add_recipe_view_valid(self):
        ...
        - Ensures that the new recipe is not saved
        (indicating the form didn't save the recipe).
        """
        form_data = {
            'title': 'Test Recipe',
    ...
    def test_delete_recipe_view(self):
        ...
        - Checks that the response status is 302
    ...
    def test_like_recipe_view(self):
        ...
        """
        response = self.client.get(reverse('like_recipe',
                                           kwargs={'slug': self.recipe.slug}))
        self.assertEqual(response.status_code, 302)
    ...
    def test_favorites_view(self):
        ...
        - Checks that the response status is 200 OK.
        - Ensures that the correct template is used and recipe title displayed.
        """
    ...
    def test_my_recipes_view(self):
        """
        Test that 'my recipes' view displays the recipes created by user.
